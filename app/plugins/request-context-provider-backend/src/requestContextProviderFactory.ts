...
/**
 * Backstage doesnt allow multiple middleware to be installed onto the root handler,
 * so this method tricks it into thinking the first arg is a unique string, which is
 * passed onto express as the first parameter. Express will detect this first arg as
 * a function, and so not be tricked like backstage was.
 *
