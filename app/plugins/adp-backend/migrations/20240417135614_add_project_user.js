...
exports.up = async function up(knex) {
    return knex.schema.createTable('delivery_project_user', table => {
      ...
      table
        ...
        .notNullable()
        .comment('ID of the Delivery Project the Delivery Project User is assigned to');
      table
        .foreign('delivery_project_id').references('id').inTable('delivery_project')
      table
      ...
      table
        .string('name')
        .notNullable()
        .comment('Name of project user');
      table
        .string('email')
        .notNullable()
        .comment('Email of project user');
      table
