...
const records = [
  {
    ...
    title: 'Europe & Trade',
    alias: 'EUTD',
    description: 'The Europe and Trade Programme, or Biodiversity, Borders & Trade (BBaT) deals with trade between GB and the EU. Covers a collection of all previous EU-Exit projects and programmes.',
    finance_code: null,
  ...
  },
  {
    ...
    title: 'Core AI',
    alias: 'CAI',
    description: 'The Core Artificial Intelligence (AI) programme is a collection of projects looking at the benefits and use cases of Gen AI, Machine Learning, etc.',
    finance_code: null,
  ...
  },
  {
    ...
    title: 'Fisheries',
    alias: '',
    description: 'The Marine Management Organisation (MMO) was created in 2009 by the Marine and Coastal Access Act. MMO is an executive non-departmental public body',
    finance_code: null,
  ...
  },
  {
    ...
    alias: 'LAP',
    description: 'The Legacy Application Programme deals with shifting IT services into the cloud from legacy datacentres. ',
    finance_code: null,
    arms_length_body_id: 'rural-payments-agency',
